...
## 💬 About Me
- 🛡️ **정보보안 / 보안관제(SOC) · 침해대응**을 목표로 공부하고 있는 최민석(Minseok CHOE)입니다.
- 🎯 현재 **[Microsoft] Cybersecurity School (930시간)** 과정을 이수 중입니다 — 하이브리드 클라우드 보안 구축, 시스템·웹 모의해킹, Azure 클라우드 보안, SIEM(Sentinel) 기반 위협 탐지·대응까지 **공격과 방어를 아우르는 실무 프로젝트 중심** 과정입니다.
- 📡 군에서 **신호정보(SIGINT)** 임무를 수행하며 다진 *정확성·책임감*을 보안 분야로 잇고 있습니다.
- 🤖 ML/DL·데이터 분석 경험을 **위협 탐지·로그 분석**에 접목하는 데 관심이 많습니다.
...
## 🧩 주요 경험
- **하이브리드 클라우드 보안 구축** — On-premise ↔ Azure 연동 인프라를 직접 구축. 방화벽 정책(NAT·패킷 필터링), VLAN 기반 네트워크 분리, 트래픽 로그 분석, Web/DB 서버 이중화 구성까지 수행. *(팀 프로젝트)*
...
## 🎓 Courses
- **Microsoft Cybersecurity School (930h)** — 대한상공회의소 경기인력개발원 *(수강 중)*
- **정보통신산업진흥원(NIPA)** — AI 고급 언어과정 (160h): 자연어처리(NLP)·기초 통계·데이터 해석·머신러닝/딥러닝 기본
- **Cisco Networking Academy** — CyberOps Associate · DevNet Associate · CCNA (Introduction to Networks · SRWE · ENSA)
- **Coursera (University. of Washington)** — Machine Learning Foundations
- **HackerRank** — SQL (Basic · Intermediate · Advanced)
- **Kaggle** — SQL · Machine Learning (입문/심화)

---

## 📜 Certifications
**Security / Network / IT**
- 정보보안산업기사 *(필기 합격, 실기 준비 중)*
- 네트워크관리사 2급
- 리눅스마스터 2급 *(필기 합격, 실기 응시 예정)*
- 정보처리기능사
- 인공지능 자격(전문가)
